from utils_cython import compute_xtx_xty as compute_xtx_xty_cython, compute_xtx_xty_naive_solution
...
if (PRACTICE_NUM >= 1):
    ...
    print(f"Cython target: \n{benchmark(compute_xtx_xty_naive_solution, [X, y])[0]} \n")
if (PRACTICE_NUM >= 2):
